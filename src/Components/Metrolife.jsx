...
function Metrolife() {
    return (
        <div>
            <div style={{ border: "1px solid white", marginTop: "0px", height: "450px" }} >
                <SimpleGrid columns={3} spacing={5} width="75%" margin="auto" marginTop="50px" >
                    ...
                    <Box boxShadow="rgba(99, 99, 99, 0.2) 0px 2px 8px 0px" height='50px'>
                        ...
                        <Text fontSize="20px" textAlign="left" marginTop="" fontWeight="bold" marginLeft="10px" >METROLIFE</Text>
                    </Box>
                    <Box boxShadow="rgba(99, 99, 99, 0.2) 0px 2px 8px 0px" height='50px'>
                ...
                <SimpleGrid columns={3} spacing={5} width="75%" margin="auto" marginTop="10px">
                    ...
                    <Box boxShadow="rgba(99, 99, 99, 0.2) 0px 2px 8px 0px" height='300px'  >
                        <SimpleGrid columns={1} spacing={2} marginTop="10px" >
                            <Box  height='86px' display="flex" gap="10px">
                                <Box width="52%">
                            ...
                            <Box  height='86px' display="flex" gap="15px">
                                <Box width="33%">
            ...
            <div style={{ border: "1px solid white", marginTop: "10px", height: "450px" }} >
                ...
                <SimpleGrid columns={3} spacing={5} width="75%" margin="auto" marginTop="10px">
                    <Box boxShadow="rgba(99, 99, 99, 0.2) 0px 2px 8px 0px" height='300px'>
                        ...
                        <Box boxShadow="rgba(99, 99, 99, 0.2) 0px 2px 8px 0px" height='300px' w="100%">
            ...
            <div style={{ border: "1px solid white", marginTop: "0px", height: "750px" }} >
                ...
                <SimpleGrid columns={3} spacing={5} width="75%" margin="auto" marginTop="10px">
                    ...
                    <Box boxShadow="rgba(99, 99, 99, 0.2) 0px 2px 8px 0px" height='340px' marginTop="-40px">
                        <Image h="100%" w="100%" src="https://www.deccanherald.com/sites/dh/themes/deccanherald/images/app_banner_home.jpg" />
                ...
                <SimpleGrid columns={3} spacing={5} width="75%" margin="auto" marginTop="40px" >
                    ...
                    <Box display="flex" gap="20px" width="750px" >
                        <Box boxShadow="rgba(99, 99, 99, 0.2) 0px 2px 8px 0px" height='250px' w="750%" bg='#A189B4'>
                            <Stack textAlign="left" marginLeft="20px" marginTop="65px">
                                <Link color="white">
            ...
            <div style={{ border: "1px solid white", marginTop: "0px", height: "750px" }} >
                ...
                <SimpleGrid columns={3} spacing={5} width="75%" margin="auto" marginTop="10px">
                    ...
                    <Box boxShadow="rgba(99, 99, 99, 0.2) 0px 2px 8px 0px" height='300px' width="80%" marginLeft="19.5%" bg="#EE9E18">
            ...
            <div style={{ border: "1px solid white", marginTop: "0px", height: "450px" }} >
                ...
                <SimpleGrid columns={3} spacing={5} width="75%" margin="auto" marginTop="10px">
                    ...
                    <Box boxShadow="rgba(99, 99, 99, 0.2) 0px 2px 8px 0px" height='300px' width="80%" marginLeft="19.5%" bg="#9F7FBB">
            ...
            <div style={{ border: "1px solid white", marginTop: "0px", height: "400px", width: "60%", margin: "auto" }}>
                ...
                <SimpleGrid columns={3} spacing={2} marginTop="10px" >
                    <Box boxShadow="rgba(99, 99, 99, 0.2) 0px 2px 8px 0px" height='320px' gap="10px">
                        <Box >
